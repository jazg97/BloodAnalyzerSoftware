...
#Class wraper for Canvas and Plotting Capabilities
...
#Class wraper for multi-item combo box
...
#Class wraper for Dialog test window
class Dialog(QtWidgets.QMainWindow):
    ...
    def gen_plot(self):
        ...
        for idx,feature in enumerate(features):
            ...
            min_value = np.min(np.array(data).flatten())
            max_value = np.max(np.array(data).flatten())
